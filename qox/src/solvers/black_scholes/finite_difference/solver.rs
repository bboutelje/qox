...
use crate::traits::payoff::{InitialCondition, Payoff};
...
impl Solver
{
    ...
    pub fn solve<IC, TReal, SReal, RCReal, VSReal>(
        ...
        where IC: InitialCondition<Resolved<SReal, RCReal, VSReal>>,
            TReal: Real,
            RCReal: Real,
            VSReal: Real,
            SReal: Real + PartialOrd + EvaluationResolver<RCReal, VSReal>,
            <SReal as EvaluationResolver<RCReal, VSReal>>::Output: 
                ...
                From<RCReal> + 
                From<VSReal> + 
                Neg<Output = <SReal as EvaluationResolver<RCReal, VSReal>>::Output>,
        for<'a> &'a <SReal as EvaluationResolver<RCReal, VSReal>>::Output: 
            Add<Output = <SReal as EvaluationResolver<RCReal, VSReal>>::Output> + 
            Sub<Output = <SReal as EvaluationResolver<RCReal, VSReal>>::Output> + 
            Mul<Output = <SReal as EvaluationResolver<RCReal, VSReal>>::Output> + 
            Div<Output = <SReal as EvaluationResolver<RCReal, VSReal>>::Output>,
    {
        ...
        self.interpolate(&mesher, &v_curr, &s_spot)

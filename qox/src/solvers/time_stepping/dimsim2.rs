...
//         // Optimal 2-stage, order 2, L-stable DIMSIM coefficients
//         // gamma is slightly smaller than 1 - 1/sqrt(2) to reduce error constant
//         let gamma = T::from_f64(0.292893218813452); // optimal gamma for min error constant
//         let a21 = one - T::from_f64(2.0) * gamma;
...
//                 // Stage starting combination U (Y_i = sum_j U_ij * [y_n, dt*f_n])
//                 u: [
//                     [one, T::from_f64(0.414213562373095)], // slightly adjusted for minimal error
//                     [one, zero],
//                 ],
...
//                 // History propagation V
//                 v: [
//                     [one, zero],
//                     [zero, zero],
//                 ],

//                 // Stage time offsets C
//                 c: [
//                     gamma,
//                     one,
//                 ],
...
//         // SDIRK-like diagonal coefficient
//         let sqrt2 = T::from_f64(2.0).sqrt();
//         let gamma = one - one / sqrt2;

//         let a21 = one - gamma - gamma;
